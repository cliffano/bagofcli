 ...
 */
function logStepItemSuccess(message) {
 ...
 */
function logStepItemWarning(message) {
  console.log('  * %s', chalk.yellow(message));
}
 ...
 */
 function logStepItemError(message) {
  console.error('  * %s', chalk.red(message));
}
